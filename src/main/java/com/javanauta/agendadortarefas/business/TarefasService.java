...
import com.javanauta.agendadortarefas.infrastructure.exceptions.ResourceNotFoundExceptions;
...
public class TarefasService {
    ...
    public void deletaTarefaPorId(String id) {
        try {
            ...
            throw new ResourceNotFoundExceptions("Erro ao deletar tarefa por id, id inexistente " + id,
                    e.getCause());
        }
    }
    ...
    public TarefasDTO alteraStatus(StatusNotificacaoEnum status, String id) {
        try {
            TarefasEntity entity = tarefasRepository.findById(id).
                    orElseThrow(() -> new ResourceNotFoundExceptions("Tarefa não encontrada " + id));
